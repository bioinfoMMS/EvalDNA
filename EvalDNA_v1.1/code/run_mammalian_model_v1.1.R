...
shortfilename = gsub("model_input_", "", args)
prefix = gsub(".csv", "", shortfilename)

write.table(score, file = paste("/usr/src/app/results/", prefix, "_final_score.txt", sep=""), sep = "", row.names = FALSE, col.names = FALSE)
